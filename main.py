...
from achievements import achievements_load_from_file, achievements_save_to_file
from actual_stats import stats_load_from_file, stats_save_to_file
...
if __name__ == '__main__':
    main()
    if not os.path.exists('./saves/ach.txt'):
        achievements_save_to_file()
    achievements_load_from_file()
    if not os.path.exists('./saves/stats.txt'):
        stats_save_to_file()
